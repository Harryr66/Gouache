        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                ...
                +{mockData.growth.users}% from last period
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                <TrendingUp className="h-3 w-3 inline mr-1" />
                +{mockData.growth.views}% from last period
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{mockData.totalLikes.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground">
                <TrendingUp className="h-3 w-3 inline mr-1" />
                +{mockData.growth.likes}% from last period
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{mockData.totalComments.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground">
                <TrendingUp className="h-3 w-3 inline mr-1" />
                +{mockData.growth.comments}% from last period
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">${mockData.revenue.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground">
                <TrendingUp className="h-3 w-3 inline mr-1" />
                +{mockData.growth.revenue}% from last period
              </p>
            </CardContent>
          </Card>
        </div>
                    ...
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div key={i} className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium">Artwork {i}</p>
                            <p className="text-xs text-muted-foreground">by Artist {i}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="text-sm font-medium">{Math.floor(Math.random() * 1000)} views</p>
                          <p className="text-xs text-muted-foreground">{Math.floor(Math.random() * 100)} likes</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground">
                    Detailed revenue analytics will be available soon.
                  </p>
                </div>
              </CardContent>
            </Card>
